    ...
    return (
        <div className="min-h-screen bg-[#0f172a] text-slate-100 font-sans">
            ...
            <header style={{
                ...
                {/* Bottom: Navigation */}
                <nav style={{ borderTop: '1px solid rgba(255,255,255,0.06)', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
                    <div style={{ maxWidth: '50rem', margin: '0 auto', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '3rem', padding: '0.7rem 1.5rem' }}>
                        <CustomLink to="/men" className="" style={{ color: '#cbd5e1', textDecoration: 'none', fontSize: '0.8rem', fontWeight: 500, letterSpacing: '1px', textTransform: 'none', transition: 'color 0.2s' }}>Men</CustomLink>
                        <CustomLink to="/women" className="" style={{ color: '#cbd5e1', textDecoration: 'none', fontSize: '0.8rem', fontWeight: 500, letterSpacing: '1px', textTransform: 'none', transition: 'color 0.2s' }}>Women</CustomLink>
                        <CustomLink to="/admin/products" className="" style={{ color: '#94a3b8', textDecoration: 'none', fontSize: '0.8rem', fontWeight: 500, letterSpacing: '0.5px', transition: 'color 0.2s', display: 'flex', alignItems: 'center', gap: '6px' }}>
                            <Package style={{ width: '14px', height: '14px' }} /> Sản phẩm
                        </CustomLink>
                        <CustomLink to="/admin/orders" className="" style={{ color: '#94a3b8', textDecoration: 'none', fontSize: '0.8rem', fontWeight: 500, letterSpacing: '0.5px', transition: 'color 0.2s', display: 'flex', alignItems: 'center', gap: '6px' }}>
                            <ClipboardList style={{ width: '14px', height: '14px' }} /> Đơn hàng
                        </CustomLink>
                        <CustomLink to="/admin/users" className="" style={{ color: '#94a3b8', textDecoration: 'none', fontSize: '0.8rem', fontWeight: 500, letterSpacing: '0.5px', transition: 'color 0.2s', display: 'flex', alignItems: 'center', gap: '6px' }}>
                            <Users style={{ width: '14px', height: '14px' }} /> Users
                        </CustomLink>
                        <CustomLink to="/admin/login" className="" style={{ color: '#cbd5e1', textDecoration: 'none', fontSize: '0.8rem', fontWeight: 500, letterSpacing: '0.5px', textTransform: 'none', transition: 'color 0.2s' }}>Admin</CustomLink>
                    </div>
                </nav>
            </header>
...
function App() {
    ...
    if (path === '/admin/login') {
        ...
        content = <AdminProductManagement />;
    } else if (path === '/admin/orders') {
        content = <AdminOrderManagement />;
    } else if (path === '/men') {
        content = (
            <MainLayout>
